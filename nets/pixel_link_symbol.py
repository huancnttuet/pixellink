        ...
        if config.model_type == MODEL_TYPE_vgg16:
            ...
            with slim.arg_scope([slim.conv2d],
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                                    padding='SAME') as sc:
                    self.arg_scope = sc
                    self.net, self.end_points,self.block1, self.block2, self.block3, self.block4, self.block5, self.fc6, self.fc7 = vgg.basenet(
                              inputs =  self.inputs)
